                    ...
                    <table id="act">
                        ...
                        <c:forEach var="activity" items="${listActHc}">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success" style=" background-color: orangered;" href="editact?activity_id=${activity.activity_id}">Update</a><br>
                                    <a style="margin-top: 5px;background-color: orangered;" class="btn btn-success" href="deleteact?activity_id=${activity.activity_id}&highcouncil_id=${activity.highcouncil_id}" onclick="confirmDelete('${activity.activity_id}')">Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
